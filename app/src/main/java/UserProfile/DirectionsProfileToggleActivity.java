...
public class DirectionsProfileToggleActivity extends AppCompatActivity
    ...
    private Point origin = Point.fromLngLat(106.64312534697416, 10.803265853252416);
    private Point destination =  Point.fromLngLat(106.70189439524084, 10.773069746539939);
...
// Setup the MapView
                ...
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        Toast.makeText(DirectionsProfileToggleActivity.this,
                               "Click on map or buttons to change route", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
     ...
     */
    private void moveDestinationMarkerToNewLocation(final LatLng pointToMoveMarkerTo) {
...
// Add the red marker icon SymbolLayer to the map
     ...
     */
    private void getSingleRoute(final String profile,final boolean fromMapClick) {
...
// You can get the generic HTTP info about the response
                ...
                switch (profile) {
                    case DirectionsCriteria.PROFILE_DRIVING:
                        ...
                        drivingButton.setText(String.format("Driving",
